...
using Relevantz.EMT.Common.Entities;
...
public partial class EEPZDbContext : DbContext
{
    ...
    public virtual DbSet<MilestonePost> MilestonePosts { get; set; }
    public virtual DbSet<MilestonePostInteraction> MilestonePostInteractions { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // ---------------- MilestonePost ----------------
        modelBuilder.Entity<MilestonePost>(entity =>
        {
            entity.HasKey(e => e.PostId).HasName("PK_MilestonePost");
            entity.ToTable("MilestonePost");
            ...
            // If you prefer DB-side timestamps, uncomment these:
            ...
            // Helpful indexes
            entity.HasIndex(e => e.EmployeeId).HasDatabaseName("IX_MilestonePost_Employee");
            entity.HasIndex(e => e.IsActive).HasDatabaseName("IX_MilestonePost_IsActive");
            entity.HasIndex(e => e.PostedAt).HasDatabaseName("IX_MilestonePost_PostedAt");
            entity.HasIndex(e => e.ExpiresAt).HasDatabaseName("IX_MilestonePost_ExpiresAt");

            // OPTIONAL: FK to Employee (you do have Employee in this context)
            entity.HasOne<Relevantz.EEPZ.Common.Entities.Employee>() // alias if you don't 'using' the EEPZ namespace here
                  .WithMany()
                  .HasForeignKey(e => e.EmployeeId)
                  .OnDelete(DeleteBehavior.ClientSetNull)
                  .HasConstraintName("FK_MilestonePost_Employee");
        });
        ...
        modelBuilder.Entity<MilestonePost>(entity =>
        {
            ...
            entity.HasIndex(e => e.EmployeeId)
                  .HasDatabaseName("IX_MilestonePost_Employee");

            entity.HasIndex(e => e.MilestoneType)
                  .HasDatabaseName("IX_MilestonePost_Type");

            entity.HasIndex(e => e.PostedAt)
                  .HasDatabaseName("IX_MilestonePost_PostedAt");

            entity.HasIndex(e => e.IsActive)
                  .HasDatabaseName("IX_MilestonePost_IsActive");

            // FK to Employee
            entity.HasOne<Relevantz.EEPZ.Common.Entities.Employee>()
                  .WithMany()
                  .HasForeignKey(e => e.EmployeeId)
                  .OnDelete(DeleteBehavior.ClientSetNull)
                  .HasConstraintName("FK_MilestonePost_Employee");
        ...
        // ---------------- MilestonePostInteraction ----------------
        modelBuilder.Entity<MilestonePostInteraction>(entity =>
        {
            entity.HasKey(e => e.InteractionId).HasName("PK_MilestonePostInteraction");
            entity.ToTable("MilestonePostInteraction");
            ...
            entity.HasIndex(e => e.PostId)
                  .HasDatabaseName("IX_MilestonePostInteraction_Post");

            entity.HasIndex(e => e.EmployeeId)
                  .HasDatabaseName("IX_MilestonePostInteraction_Employee");

            entity.HasIndex(e => new { e.PostId, e.InteractionType })
                  .HasDatabaseName("IX_MilestonePostInteraction_Post_Type");

            entity.HasIndex(e => e.IsEdited)
                  .HasDatabaseName("IX_MilestonePostInteraction_IsEdited");

            // FK to MilestonePost
            entity.HasOne<MilestonePost>()
                  .WithMany()
                  .HasForeignKey(e => e.PostId)
                  .OnDelete(DeleteBehavior.Cascade)
                  .HasConstraintName("FK_MilestonePostInteraction_Post");
            ...
            entity.HasOne<Relevantz.EEPZ.Common.Entities.Employee>()
                  ...
                  .HasForeignKey(e => e.EmployeeId)
                  .OnDelete(DeleteBehavior.ClientSetNull)
                  .HasConstraintName("FK_MilestonePostInteraction_Employee");

            // Self-reply threading
            entity.HasOne<MilestonePostInteraction>()
                  .WithMany()
                  .HasForeignKey(e => e.ReplyToInteractionId)
                  .OnDelete(DeleteBehavior.SetNull)
                  .HasConstraintName("FK_MilestonePostInteraction_Parent");
        });
